...
<body>   
			...
			<div class="container shop m-auto mb-5">
				<form action="update_pro.jsp" name="updateForm" method="post" onsubmit="return checkAccount()" >
					...
					<div class="input-group mb-3 row">
						...
						<label class="form-control col-md-10" name="id" value="<%= loginUser.getId() %>">  <%= loginUser.getId() %></label>
						<input type="hidden" class="form-control col-md-10" 
							   name="id" placeholder="이름" required
	...
	<script>
		...
		function checkAccount() {
		    const form = document.forms["updateForm"]; // 폼 객체 이름 수정
