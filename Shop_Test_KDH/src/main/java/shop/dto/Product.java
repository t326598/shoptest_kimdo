...
public class Product implements Serializable {
	...
	public Product(String productId, String name, Integer unitPrice, String description, String manufacturer,
			String category, long unitsInStock, String condition, String file, int quantity, String userId, int orderNo,
